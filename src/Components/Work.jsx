      ...
      <div className="container mx-auto p-20">
        <div class="grid lg:grid-cols-2 gap-4">
          <div>
            ...
            <span className="text-[#1bf7a8] text-xl">
              {" "}
              Html 5, Css 3, JavaScript, react vite, tailwind
            </span>
      ...
      <div className="container mx-auto p-20">
        <div class="grid lg:grid-cols-2 gap-4">
          <div>
            ...
            <span className="text-[#1bf7a8] text-xl">
              {" "}
              Html 5, Css 3, 3js JavaScript, tailwind, react vite.
            </span>
            <div className="border-b border-gray-600 mt-11"></div>
            <div className="mt-5 flex gap-4">
              <i class="text-4xl p-4 text-white bg-[#28272C] rounded-full ri-arrow-right-up-line"></i>

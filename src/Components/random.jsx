        ...
        <div className="">
          <div class="grid xl:grid-cols-6 lg:grid-cols-1  gap-4 xl:px-32 lg:p-16" >
            ...
            <div className=" col-span-4 p-1">
              ...
              <div class="grid sm:grid-cols-2 mm:grid-cols-1 gap-4">
                <div className="bg-[#232229] p-6 rounded-lg">
                  ...
                  <div className="flex justify-start items-center gap-2">
                    ...
                    <div className="text-xs text-gray-500">
                      Itahari Academic solution
                    </div>{" "}
                  </div>
                </div>
                <div className="bg-[#232229] p-6 rounded-lg">
                  <h1 className="text-[#1BF7A8]">2024</h1>
                  <h2 className="mb-8 mt-4 text-[#F5F4F9]">
                ...
                <div className="bg-[#232229] p-6 rounded-lg">
                  <h1 className="text-[#1BF7A8]">2023</h1>
                  <h2 className="mb-8 mt-4 text-[#F5F4F9]">
                    Micro-soft office Teacher
                  </h2>
                  <div className="flex justify-start items-center gap-2">
                    <i class="text-[#1BF7A8] text-1xl ri-git-commit-fill"></i>
                    <div className="text-xs text-gray-500">
                      Sushma Gordawari College
                    </div>{" "}
                  </div>
                </div>
                <div className="bg-[#232229] p-6 rounded-lg">
                  <h1 className="text-[#1BF7A8]">2024</h1>
                  <h2 className="mb-8 mt-4 text-[#F5F4F9]">IT officer </h2>
                  <div className="flex justify-start items-center gap-2">
                    <i class="text-[#1BF7A8] text-1xl ri-git-commit-fill"></i>
                    <div className="text-xs text-gray-500">
                      Iron Gate in Putalisadak
                    </div>{" "}
                  </div>
                </div>
                <div className="bg-[#232229] p-6 rounded-lg">
          ...
          <div className=" xl:col-span-4 p-1">
              ...
              <div class="grid sm:grid-cols-2 mm:grid-cols-1 gap-4">
                ...
                <div className="bg-[#232229] p-6 rounded-lg">
                  <h1 className="text-[#1BF7A8]">2016-2018</h1>
                  <h2 className="mb-8 mt-4 text-[#F5F4F9]">
                ...
                <div className="bg-[#232229] p-6 rounded-lg">
                  <h1 className="text-[#1BF7A8]">2016</h1>
                  <h2 className="mb-8 mt-4 text-[#F5F4F9]"> SEE Class 10 </h2>
                  <div className="flex justify-start items-center gap-2">
                    <i class="text-[#1BF7A8] text-1xl ri-git-commit-fill"></i>
                    <div className="text-xs text-gray-500">
                      Him Shikhar English School
                    </div>{" "}
                  </div>
                </div>
                <div className="bg-[#232229] p-6 rounded-lg">
            ...
            <div className=" xl:col-span-4 p-1">
              ...
              <div class="grid xl:grid-cols-4 md:grid-cols-3 sm:grid-cols-2 mm:grid-cols-1  gap-4 mt-14 relative">
                <div class="group relative">
                  ...
                  <i class="text-6xl flex items-center justify-center p-7 text-white bg-[#28272C] hover:text-[#1BF7A8] duration-1000 ease-in-out rounded-sm ri-css3-fill"></i>
                </div>
                ...
                <div class="group relative">
                  ...
                  <i class="text-6xl flex items-center justify-center p-7 text-white bg-[#28272C] hover:text-[#1BF7A8] duration-1000 ease-in-out rounded-sm ri-html5-fill"></i>
                </div>
                ...
                <div class="group relative">
                  ...
                  <i class="text-6xl flex items-center justify-center p-7 text-white bg-[#28272C] hover:text-[#1BF7A8] duration-1000 ease-in-out rounded-sm ri-javascript-fill"></i>
                </div>
                ...
                <div class="group relative">
                  ...
                  <i class="text-6xl flex items-center justify-center p-7 text-white bg-[#28272C] hover:text-[#1BF7A8] duration-1000 ease-in-out rounded-sm ri-tailwind-css-fill"></i>
                </div>
                ...
                <div class="group relative">
                  ...
                  <i class="text-6xl flex items-center justify-center p-7 text-white bg-[#28272C] hover:text-[#1BF7A8] duration-1000 ease-in-out rounded-sm ri-reactjs-fill"></i>
                </div>
                ...
                <div class="group relative">
                  ...
                  <i class="text-6xl flex items-center justify-center p-7 text-white bg-[#28272C] hover:text-[#1BF7A8] duration-1000 ease-in-out rounded-sm ri-figma-line"></i>
                </div>
                ...
                <div class="group relative">
                  ...
                  <i class="text-6xl flex items-center justify-center p-7 text-white bg-[#28272C] hover:text-[#1BF7A8] duration-1000 ease-in-out rounded-sm ri-github-fill"></i>
                </div>
